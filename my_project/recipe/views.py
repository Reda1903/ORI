...
#######################################################################################################
    ...
    if q_total > 0 :
        for i in range (len(ingredient_Recipe)) :
            perc.append( 
                round(
                    ingredient_Recipe[i].quantity / q_total * 100, 2
                    )
...
######################################################################################################################################
        ...
        context['total_calorie_kcal_bis'] = round (context['total_calorie_kcal'] / quantite_total * 12.5, 5)
        context['total_calorie_bis'] = round( context['total_calorie'] / quantite_total * 12.5, 5) 

        context['total_calorie_kcal_gda'] = round (context['total_calorie_kcal_bis'] / 2000 *100, 5)
        context['total_calorie_gda'] = round ( context['total_calorie'] / 8400 * 100, 5)



        context['total_protein_bis'] = round (totaux['total_proteins'] / quantite_total * 12.5, 5)
        context['total_protein_gda'] = round (context['total_protein_bis'] / 50 * 100, 5)


        context['total_glucide_bis'] = round (totaux['total_glucide'] / quantite_total * 12.5, 5) 
        context['total_sucres_bis'] = round (totaux['total_sucres'] / quantite_total * 12.5, 5)

        context['total_glucide_gda'] =  round (context['total_glucide_bis'] / 260 * 100, 5)
        context['total_sucres_gda'] =  round (context['total_sucres_bis'] / 90 * 100, 5)




        context['total_lipide_bis'] = round (totaux['total_lipide'] / quantite_total * 12.5, 5)
        context['total_AGsatures_bis'] = round(totaux['total_AGsatures'] / quantite_total * 12.5, 5)

        context['total_lipide_gda'] = round (context['total_lipide_bis'] / 70 * 100, 5)
        context['total_AGsatures_gda'] = round (context['total_AGsatures_bis'] / 20 * 100, 5)



        context['total_fibre_bis'] = round (totaux['total_fibres'] / quantite_total * 12.5, 5)
        context['total_sodium_bis'] = round (totaux["total_sodium"] / quantite_total * 12.5, 5)

        context['total_fibre_gda'] = round (context['total_fibre_bis'] / 25 * 100, 5)
        context['total_sodium_gda'] = round (context["total_sodium_bis"] / 2.4 * 100, 5)
